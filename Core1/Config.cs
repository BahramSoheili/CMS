...
namespace Core
{
    public static class Config
    {
        public static void AddCoreServices(this IServiceCollection services)
        {
            ...
            services.TryAddScoped<IExternalRabbitMqEventProducer, RabbitMqProducer>();
            services.TryAddSingleton<IExternalRabbitMqEventConsumer, RabbitMqConsumer>();
            services.AddHostedService<ExternalRabbitMqEventConsumerBackgroundWorker>();
            ...
            services.TryAddScoped<IEventRabbitMqBus, EventRabbitMqBus>();
